...
#     genre_attributes: { name: game['genres'][0]['name'] },
#     artworks: game['artworks'].map { |artwork| artwork['url'] },
#     screenshots: game['screenshots'].map { |screenshot| screenshot['url'] },
